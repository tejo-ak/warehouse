...
class Referensi(models.Model):
    nama = models.CharField(max_length=32, null=True, blank=True)
    grup = models.CharField(max_length=2, null=True, blank=True)
    keterangan = models.CharField(max_length=512, null=True, blank=True)
...
#    nama = models.CharField(max_length=32, null=True, blank=True)
#    keterangan = models.CharField(max_length=512, null=True, blank=True)
#    wip = models.ForeignKey('Inventory', related_name='wips')
#    sisa = models.ForeignKey('Inventory', related_name='sisas')
#    defect = models.ForeignKey('Inventory', related_name='defects')
#    finished = models.ForeignKey('Inventory', related_name='finisheds')


#class FormulaKonversi(models.Model):
#    barang = models.CharField(max_length=32, null=True, blank=True)
#    konversi = models.ForeignKey('Konversi', related_name='formulas')
...
#
#
#class JurnalKonversi(models.Model):
#    konversi = models.ForeignKey('Konversi', related_name='jurnal')
#    awal = models.DateTimeField()
#    akhir = models.DateTimeField()
#    keterangan = models.CharField(max_length=512, null=True, blank=True)
#    batch = models.CharField(max_length=6)
#    status = models.ForeignKey('Referensi', related_name='statuses')
#
#
#class StepKonversi(models.Model):
#    nama = models.CharField(max_length=32, null=True, blank=True)
#    dari = models.ForeignKey('Inventory', related_name='daris')
#    ke = models.ForeignKey('Inventory', related_name='kes')
#
#
#class JurnalStepKonversi(models.Model):
#    jurnal = models.ForeignKey('JurnalKonversi', related_name='jurnals')
#    step = models.ForeignKey('StepKonversi', related_name='jurnals')
...
class DokumenPabean(models.Model):
    supplier = models.ForeignKey('Supplier', null=True)
    customer = models.ForeignKey('Customer', related_name='dokPabeans', null=True)
    ...
    nomorDokumen = models.CharField(max_length=16, null=True, blank=True)
    tanggalDokumen = models.DateField(auto_now=False, null=True, blank=True)
    kantor = models.CharField(max_length=6, null=True, blank=True)
    kantorAwas = models.CharField(max_length=6, null=True, blank=True)
    nomorInvoice = models.CharField(max_length=16, null=True, blank=True)
    tanggalInvoice = models.DateField(auto_now=False, null=True, blank=True)
    nomorBl = models.CharField(max_length=16, null=True, blank=True)
    tanggalBl = models.DateField(auto_now=False, null=True, blank=True)
...
class ItemDokumenPabean(models.Model):
    ...
    kemasan = models.CharField(max_length=6, null=True, blank=True)
    jumlahKemasan = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    nilaiPabean = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
